...
public class MiStore extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        BigDecimal bglng = new BigDecimal(Double.valueOf(lng)+0.005456);
        BigDecimal bglat = new BigDecimal(Double.valueOf(lat)-0.001849);
...
//        String curTime = new String(request.getParameter("ct").getBytes("ISO-8859-1"),"UTF-8");
        ...
        out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("D:\\mitrace.txt", true)));
